          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/background.jpg'), // Ganti dengan nama file gambar Anda
                      ...
                      : Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [Colors.blueAccent, Colors.purpleAccent], // Warna gradien
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              padding: EdgeInsets.symmetric(vertical: 15), backgroundColor: Colors.transparent, // Menghilangkan warna latar belakang
                              shadowColor: Colors.transparent, // Menghilangkan bayangan tombol default
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(30), // Sudut membulat
                              ),
                            ),
